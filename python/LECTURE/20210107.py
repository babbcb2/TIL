...
userList01 = [tmp ** 2 for tmp in userList]
print('comprehension -',userList01)
...
for word in wordVec:
    print(word)
    # get () : 해당 key 에 대한 value를 가져오는 함수
    wordCnt[word]: wordCnt.get(word, 0) + 1
print(wordCnt)

wordCnt01 = {}
for word in wordVec:
    if word in wordCnt01:
        wordCnt01[word] += 1
    else:
        wordCnt01[word] = 1
...
for i in range(2, 10):
    ...
    string = '''저는 여러분과 함께 파이썬 강의를 듣고있는 유창호입니다.
    어려운 시기입니다. 
    나이는 숫자에 불과합니다!!
    '''
